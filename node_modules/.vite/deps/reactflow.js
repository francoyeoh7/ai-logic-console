...
function MiniMap({
  ...
  const { boundingRect, viewBB, rfId } = useStore(selector2, shallow$12);
...
var Controls = ({ style: style2, showZoom = true, showFitView = true, showInteractive = true, fitViewOptions, onZoomIn, onZoomOut, onFitView, onInteractiveChange, className, children: children2, position = "bottom-left" }) => {
  ...
  const { isInteractive, minZoomReached, maxZoomReached } = useStore(selector3, shallow$13);
...
function Background({
  ...
  const { transform: transform2, patternId } = useStore(selector4, shallow$14);
...
// node_modules/@reactflow/node-toolbar/node_modules/zustand/esm/shallow.mjs
function shallow$15(objA, objB) {
  if (Object.is(objA, objB)) {
    return true;
  }
  if (typeof objA !== "object" || objA === null || typeof objB !== "object" || objB === null) {
...
function NodeToolbar({ nodeId, children: children2, className, style: style2, isVisible, position = Position.Top, offset = 10, align = "center", ...rest }) {
  ...
  const { transform: transform2, nodeOrigin, selectedNodesCount } = useStore(storeSelector, shallow$15);
